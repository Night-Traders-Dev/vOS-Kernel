...
int syscall_fs_write(const char *filename, const char *data, int size); // Changed to int
int syscall_fs_read(const char *filename, char *buffer, int size); // Changed to int
